            ...
            if (err) {
              ...
              if (document.querySelectorAll('.units-table')[0]) {
                ...
                for (let x = 0; x < angebotInner.length; x++) {
                  ...
                  let document = new JSDOM(await crawlInnerNl(href, a).body).window.document;
                  ...
                  if (document.querySelectorAll('.financing-variant-column').length > 0) {
                    costs = document.querySelectorAll('.financing-variant-column')[0].innerHTML;
                    funds = document.querySelectorAll('.financing-variant-column')[1].innerHTML;
                  }
...
async function crawlInnerNl(href, a) {
    return await rp({
      ...
      console.log('https://www.wohnen.at' + a.getAttribute("onclick").split('\'')[1]);
